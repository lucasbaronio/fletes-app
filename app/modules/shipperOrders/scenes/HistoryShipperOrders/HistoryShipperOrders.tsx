...
class HistoryShipperOrders extends React.Component<MyProps, MyState> {
    ...
    onSuccess = () => {
        ...
        navigation.navigate('ShipperHistoryOrdersRoutes', { screen: 'MapShipperOrderDetails'});
    }
...
function mapStateToProps(state, props) {
    return {
        historyOrders: state.shipperOrdersReducer.historyOrders,
        isLoading: state.shipperOrdersReducer.isLoading,
    }
}

export default connect(mapStateToProps, { setShipperOrderSelected, getHistoryOrdersShipper })(HistoryShipperOrders);
